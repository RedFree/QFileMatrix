    ...
    : QWidget(parent)
{
    ...
    gotoRow->addWidget(new QLabel(QStringLiteral("GOTO X")));
    ...
    gotoRow->addWidget(m_xSpin);
    gotoRow->addWidget(new QLabel(QStringLiteral("GOTO Y")));
    gotoRow->addWidget(m_ySpin);
