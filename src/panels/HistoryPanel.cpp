    ...
    : QWidget(parent)
{
    ...
    m_table->setStyleSheet(QStringLiteral(
        ...
        "QHeaderView::section{background:%1;border:none;border-bottom:1px solid %4;padding:8px 10px;color:%5;font-size:10.5px;font-weight:600;letter-spacing:0.02em;text-align:left;}"
